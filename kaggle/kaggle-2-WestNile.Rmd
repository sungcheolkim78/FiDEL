...
```{r}
plot_performance(fde2, nmethod_list=c(3, 5, 7), nsample=200, filename='results/WNV_perf_fde2.pdf')
```

```{r}
plot_performance_nmethods(fde2, nmethod_list=3:10, nsample=200, filename='results/WNV_perf_nmethod_fde2.pdf')
```
